...
namespace TheCloudShopsLoader
{
    public class Program
    {
        ...
        //RBAC must be configured for account running the app 

        private static readonly string KeyAddress = ConfigurationManager.AppSettings["KeyAddress"];
        // The primary key for the Azure Cosmos account.
        private static readonly string KeyName = ConfigurationManager.AppSettings["KeyName"];
        ...
        {
            var tokenCredential = new AzureCliCredential(); //new DefaultAzureCredential();
